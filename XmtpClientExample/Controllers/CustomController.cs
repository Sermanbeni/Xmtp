...
[ClientController("client")] // set the client names for which client the endpoint needs to be configured (clientType).
                             // If not set, the controller goes to all servers
[Route("custom")] // set the root of the endpoints
public class CustomController<T> : ClientControllerBase<T>
{
