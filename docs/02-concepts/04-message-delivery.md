...
5. Wait for response to return
   ...
6. Receive message on remote side
7. Invoke message endpoint method
8. Send back endpoint return value with the message request ID
   ...
...
3. If response -> handle response and return (read Response handling below)
